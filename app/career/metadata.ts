...
export const metadata: Metadata = {
  ...
  description: "Grow your professional network and advance your career with Changer Fusions' comprehensive career development services. From career counseling to networking opportunities, we're here to support your professional journey.",
  keywords: [
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Career Development - Changer Fusions",
      },
    ],
  },
  twitter: {
