...
export default function EventsOpportunitiesPage() {
  const route = "/careers/attachments/events-opportunities";
  ...
  if (page?.section === "careers") {
    return (
      <CareerDetailTemplate
        activeHref={route}
        title={page.title || "Events Attachment Opportunities"}
        heroLabel={page.hero_label || "EVENTS (ATTACHMENTS)"}
        ...
        ctaDescription={page.cta_description || "Contact us to learn more about Events Attachment opportunities."}
        icon={Briefcase}
      />
    );
  }
