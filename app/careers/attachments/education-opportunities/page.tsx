...
import { ArrowLeft, CheckCircle, Mail, Phone, Briefcase } from "lucide-react";
...
export default function EducationOpportunitiesPage() {
  const route = "/careers/attachments/education-opportunities";
  ...
  if (page?.section === "careers") {
    return (
      <CareerDetailTemplate
        activeHref={route}
        title={page.title || "Education Attachment Opportunities"}
        heroLabel={page.hero_label || "EDUCATION (ATTACHMENTS)"}
        ...
        ctaDescription={page.cta_description || "Contact us to learn more about Education Attachment opportunities."}
        icon={Briefcase}
      />
    );
  }
        ...
        <div className="container-custom">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Education Attachment Opportunities
            </h1>
            <p className="text-xl md:text-2xl text-white/90">
              Support educational initiatives and training programs in marketing and business
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container-custom max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-gray-700 mb-6">
              Our Education Attachment Program allows you to support educational initiatives, training programs, and workshops. You'll help develop educational content and support learning programs.
            </p>
            ...
            <ul className="space-y-3 mb-8">
              {[
                "Currently enrolled in education, training, or related program",
            ...
            <div className="bg-primary-50 border border-primary-200 rounded-lg p-6 mt-8">
              ...
              <p className="text-gray-700 mb-4">
                Contact us to learn more about Education Attachment opportunities.
              </p>
