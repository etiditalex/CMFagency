...
export default function FashionOpportunitiesPage() {
  const route = "/careers/attachments/fashion-opportunities";
  ...
  if (page?.section === "careers") {
    return (
      <CareerDetailTemplate
        activeHref={route}
        title={page.title || "Fashion Attachment Opportunities"}
        heroLabel={page.hero_label || "FASHION (ATTACHMENTS)"}
        description={page.description || "Explore the fashion industry through styling, event coordination, and brand management."}
        ...
        ctaDescription={page.cta_description || "Contact us to learn more about Fashion Attachment opportunities."}
        icon={Briefcase}
      />
    );
  }
