...
import { ArrowLeft, CheckCircle, Mail, Phone, Users } from "lucide-react";
...
export default function JobsMarketingOpportunitiesPage() {
  const route = "/careers/jobs/marketing-opportunities";
  ...
  if (page?.section === "careers") {
    return (
      <CareerDetailTemplate
        activeHref={route}
        title={page.title || "Marketing Job Opportunities"}
        heroLabel={page.hero_label || "MARKETING (JOBS)"}
        description={page.description || "Join our marketing team in full-time or part-time roles across various marketing disciplines."}
        ...
        ctaDescription={page.cta_description || "Send your CV and cover letter to express your interest in this role."}
        icon={Users}
      />
    );
  }
