        ...
        <div className="container-custom max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-gray-700 mb-6">
              Our Education Internship Program allows you to support educational initiatives, develop training materials, and facilitate learning programs.
            </p>
            ...
            <ul className="space-y-3 mb-8">
              {[
                "Currently enrolled in or recently graduated from education, training, or related program",
                "Passion for teaching and educational development",
            ...
            <div className="bg-secondary-50 border border-secondary-200 rounded-lg p-6 mt-8">
              ...
              <p className="text-gray-700 mb-4">
                Contact us to learn more about Education Internship opportunities.
              </p>
