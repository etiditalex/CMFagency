...
export default function InternshipMarketingOpportunitiesPage() {
  const route = "/careers/internships/marketing-opportunities";
  ...
  if (page?.section === "careers") {
    return (
      <CareerDetailTemplate
        activeHref={route}
        title={page.title || "Marketing Internship Opportunities"}
        heroLabel={page.hero_label || "MARKETING (INTERNSHIPS)"}
        description={page.description || "Join our marketing team and develop skills in digital marketing, content creation, and campaign management."}
        ...
        ctaDescription={page.cta_description || "Contact us to learn more about internship opportunities."}
        icon={GraduationCap}
      />
    );
  }
