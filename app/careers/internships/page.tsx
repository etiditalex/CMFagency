...
export default function InternshipsPage() {
  const route = "/careers/internships";
  ...
  if (page?.section === "careers") {
    return (
      <CareerDetailTemplate
        activeHref={route}
        title={page.title || "Internship Opportunities"}
        heroLabel={page.hero_label || "INTERNSHIPS"}
        description={page.description || "Join our internship programs to develop skills and build your professional portfolio."}
