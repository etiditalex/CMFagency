...
export const metadata: Metadata = {
  ...
  description: "Building strong partnerships to deliver exceptional value and create lasting impact. Learn about partnering with Changer Fusions for mutual growth and success.",
  keywords: [
    "Changer Fusions partners",
    "marketing agency partnerships",
    "strategic alliances",
    "corporate partnerships Kenya",
  ],
  openGraph: {
    title: "Our Partners - Strategic Partnerships | Changer Fusions",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Our Partners - Changer Fusions",
      },
    ],
  },
  twitter: {
