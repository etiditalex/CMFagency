  ...
  return (
    <div className="text-left">
      <div className="flex flex-start justify-between gap-4 flex-col sm:flex-row">
        <div>
          <h2 className="text-xl md:text-2xl font-bold text-[#1a2332] text-left pb-3 border-b border-hairline">Edit Event</h2>
                ...
                <>
                  ...
                  <div className="max-h-64 overflow-auto rounded border border-gray-200 bg-white text-xs">
                    <table className="w-full text-left">
                      <thead className="bg-white text-gray-600 sticky top-0 border-b border-hairline">
                        <tr>
