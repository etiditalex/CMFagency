...
export default function BlogSidebarAdsPage() {
  ...
  return (
    <div className="text-left max-w-4xl">
      ...
      <h2 className="text-xl md:text-2xl font-bold text-[#1a2332] pb-3 border-b border-hairline">Blog sidebar ads</h2>
      ...
      <form onSubmit={addRow} className="border border-hairline bg-white p-6 mb-10 space-y-4">
