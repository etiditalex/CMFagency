    ...
    try {
      ...
      if (type === "vote") {
        ...
        for (let i = 0; i < contestants.length; i++) {
          ...
          cleaned.push({ campaign_id: campaign.id, name: c.name.trim(), image_url: imgUrl, sort_order: cleaned.length });
        }
        if (cleaned.length === 0) {
  ...
  return (
    <div className="text-left">
      <div className="flex items-start justify-between gap-4 flex-col sm:flex-row">
        <div>
          <h2 className="text-xl md:text-2xl font-bold text-[#1a2332] text-left pb-3 border-b border-hairline">New Campaign</h2>
