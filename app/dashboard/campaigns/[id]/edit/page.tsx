  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        ...
        const existingImage = (campaign as { image_url?: string | null }).image_url ?? "";
  ...
  return (
    <div className="text-left">
      <div className="flex items-start justify-between gap-4 flex-col sm:flex-row">
        <div>
          <h2 className="text-xl md:text-2xl font-bold text-[#1a2332] text-left pb-3 border-b border-hairline">Edit Campaign</h2>
