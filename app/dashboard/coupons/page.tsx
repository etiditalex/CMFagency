  ...
  return (
    <div className="text-left">
      <div className="flex items-start justify-between gap-4 flex-col sm:flex-row">
        <div>
          <h2 className="text-xl md:text-2xl font-bold text-[#1a2332] text-left pb-3 border-b border-hairline">Coupons</h2>
      ...
      <div className="mt-6 bg-white border border-hairline overflow-hidden">
        <div className="px-4 py-3 border-b border-hairline bg-white flex items-center gap-2">
          <BadgePercent className="w-5 h-5 text-primary-600" />
