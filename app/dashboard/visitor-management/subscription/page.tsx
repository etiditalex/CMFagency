  ...
  return (
    <div className="space-y-6 max-w-3xl">
      <div>
        ...
        <h1 className="mt-2 text-2xl font-bold text-[#1a2332] flex items-center gap-2 pb-3 border-b border-hairline">
      ...
      {subscription ? (
        <div className="border border-hairline bg-white p-5 space-y-2">
