      ...
      <section className="relative section-padding overflow-hidden min-h-[400px] md:min-h-[500px] flex items-center">
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Website Development & Design</h1>
            <p className="text-xl text-white/90 leading-relaxed">
              Create custom websites that are both visually appealing and user-friendly. We offer web development and maintenance services to ensure your website stays up-to-date and functions smoothly.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="section-padding bg-primary-600 text-white">
        <div className="container-custom text-center">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6">Ready to Build Your Online Presence?</h2>
