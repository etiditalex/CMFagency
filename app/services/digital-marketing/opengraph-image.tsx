    ...
    (
      ...
      >
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
          <div style={{ display: "flex", flexDirection: "column", gap: 16, maxWidth: 840 }}>
            ...
            <div style={{ color: "rgba(255,255,255,0.9)", fontSize: 30, lineHeight: 1.35 }}>
              SEO, PPC, social media and multi-channel strategy to grow awareness, leads and revenue.
            </div>
          </div>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
          ...
          <div style={{ color: "rgba(255,255,255,0.85)", fontSize: 22 }}>Changer Fusions</div>
        </div>
      </div>
    ),
    size
