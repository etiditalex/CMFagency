 ...
 * - Inline scripts generated by Next.js
 * - <Script> components when given the nonce prop
 *
 * `style-src` intentionally does NOT use the nonce: if a nonce is present, browsers ignore
 * `'unsafe-inline'` for style, which breaks Google AdSense and other scripts that set inline
 * styles. Script injection remains locked down via nonce + strict-dynamic.
 *
