          ...
          <div className="p-6">
            ...
            <div className="space-y-3 mb-6">
              ...
              <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-[#1877F2] text-white rounded-lg hover:bg-[#166FE5] transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed"
              >
