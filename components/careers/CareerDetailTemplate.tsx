...
export default function CareerDetailTemplate({
  activeHref,
  title,
  heroLabel,
  description,
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="w-full px-4 sm:px-6 lg:px-10 xl:px-14 2xl:px-16 py-4">
          <div className="text-sm text-gray-600">
            ...
            {" > "}
            <Link href="/careers" className="hover:text-secondary-600">
              CAREERS
            </Link>
            {" > "}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-10">
          <aside className="lg:col-span-1">
            <div className="bg-white border-2 border-secondary-600 rounded-lg p-6 sticky top-24">
              <h2 className="text-xl font-bold text-gray-900 mb-6">CAREERS</h2>
