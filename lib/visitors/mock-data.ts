...
export const MOCK_VISITORS: VisitorRecord[] = [
  ...
  },
  {
    ...
    visitTime: "14:15",
    status: "checked_in",
    checkedInAt: new Date(`${TODAY_YMD}T14:15:00`).toISOString(),
    checkedOutAt: null,
  ...
  },
  {
    ...
    visitTime: "08:45",
    status: "checked_out",
    checkedInAt: new Date(`${TODAY_YMD}T08:45:00`).toISOString(),
    checkedOutAt: new Date(`${TODAY_YMD}T09:30:00`).toISOString(),
